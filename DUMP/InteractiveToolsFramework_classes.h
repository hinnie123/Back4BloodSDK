...
struct UBrushBaseProperties : UInteractiveToolPropertySet {
	...
	float BrushDepth; // 0x64(0x04)
	float BrushStrength; // 0x68(0x04)
	float BrushFalloffAmount; // 0x6c(0x04)
	bool bShowStrength; // 0x70(0x01)
	bool bShowFalloff; // 0x71(0x01)
...
struct UGizmoBaseComponent : UPrimitiveComponent {
	struct FLinearColor Color; // 0x4a0(0x10)
	float HoverSizeMultiplier; // 0x4b0(0x04)
	float PixelHitDistanceThreshold; // 0x4b4(0x04)
	char pad_4B8[0x8]; // 0x4b8(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (None) // @ game+0xfffffffec0000000
};

// Class InteractiveToolsFramework.GizmoArrowComponent
// Size: 0x4e0 (Inherited: 0x4c0)
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x4c0(0x0c)
	float Gap; // 0x4cc(0x04)
	float Length; // 0x4d0(0x04)
	float Thickness; // 0x4d4(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x4c0(0x0c)
	char pad_4CC[0x4]; // 0x4cc(0x04)
	struct FQuat Rotation; // 0x4d0(0x10)
	struct FVector Dimensions; // 0x4e0(0x0c)
	float LineThickness; // 0x4ec(0x04)
	bool bRemoveHiddenLines; // 0x4f0(0x01)
	bool bEnableAxisFlip; // 0x4f1(0x01)
...
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x4c0(0x0c)
	float Radius; // 0x4cc(0x04)
	float Thickness; // 0x4d0(0x04)
	int32_t NumSides; // 0x4d4(0x04)
	bool bViewAligned; // 0x4d8(0x01)
	bool bOnlyAllowFrontFacingHits; // 0x4d9(0x01)
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (None) // @ game+0xfffffffec0000000
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (None) // @ game+0xfffffffec0000000
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (None) // @ game+0xfffffffec0000000
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (None) // @ game+0xfffffffec0000000
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (None) // @ game+0xfffffffec0000000
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (None) // @ game+0xfffffffec0000000
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x4c0(0x0c)
	float HandleSize; // 0x4cc(0x04)
	float Thickness; // 0x4d0(0x04)
	struct FVector Direction; // 0x4d4(0x0c)
	float Length; // 0x4e0(0x04)
	bool bImageScale; // 0x4e4(0x01)
...
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x4c0(0x0c)
	struct FVector DirectionY; // 0x4cc(0x0c)
	float OffsetX; // 0x4d8(0x04)
	float OffsetY; // 0x4dc(0x04)
	float LengthX; // 0x4e0(0x04)
	float LengthY; // 0x4e4(0x04)
	float Thickness; // 0x4e8(0x04)
	char SegmentFlags; // 0x4ec(0x01)
...
struct UInteractiveToolsContext : UObject {
	...
	struct TSoftClassPtr<UObject> ToolManagerClass; // 0x78(0x28)
};

// Class InteractiveToolsFramework.IntervalGizmoActor
// Size: 0x268 (Inherited: 0x250)
struct AIntervalGizmoActor : AGizmoActor {
	struct UGizmoLineHandleComponent* UpIntervalComponent; // 0x250(0x08)
	struct UGizmoLineHandleComponent* DownIntervalComponent; // 0x258(0x08)
	struct UGizmoLineHandleComponent* ForwardIntervalComponent; // 0x260(0x08)
};
...
struct ATransformGizmoActor : AGizmoActor {
	struct UPrimitiveComponent* TranslateX; // 0x250(0x08)
	struct UPrimitiveComponent* TranslateY; // 0x258(0x08)
	struct UPrimitiveComponent* TranslateZ; // 0x260(0x08)
	struct UPrimitiveComponent* TranslateYZ; // 0x268(0x08)
	struct UPrimitiveComponent* TranslateXZ; // 0x270(0x08)
	struct UPrimitiveComponent* TranslateXY; // 0x278(0x08)
	struct UPrimitiveComponent* RotateX; // 0x280(0x08)
	struct UPrimitiveComponent* RotateY; // 0x288(0x08)
	struct UPrimitiveComponent* RotateZ; // 0x290(0x08)
	struct UPrimitiveComponent* UniformScale; // 0x298(0x08)
	struct UPrimitiveComponent* AxisScaleX; // 0x2a0(0x08)
	struct UPrimitiveComponent* AxisScaleY; // 0x2a8(0x08)
	struct UPrimitiveComponent* AxisScaleZ; // 0x2b0(0x08)
	struct UPrimitiveComponent* PlaneScaleYZ; // 0x2b8(0x08)
	struct UPrimitiveComponent* PlaneScaleXZ; // 0x2c0(0x08)
	struct UPrimitiveComponent* PlaneScaleXY; // 0x2c8(0x08)
};

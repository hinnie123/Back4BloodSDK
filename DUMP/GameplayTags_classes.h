...
struct UBlueprintGameplayTagLibrary : UBlueprintFunctionLibrary {
	...
	bool RemoveGameplayTag(struct FGameplayTagContainer TagContainer, struct FGameplayTag Tag); // Function GameplayTags.BlueprintGameplayTagLibrary.RemoveGameplayTag // (None) // @ game+0xfffffffec0000000
};
...
struct UGameplayTagAssetInterface : UInterface {
	...
	void RemoveGameplayTags(struct FGameplayTagContainer Tag); // Function GameplayTags.GameplayTagAssetInterface.RemoveGameplayTags // (None) // @ game+0xfffffffec0000000
};

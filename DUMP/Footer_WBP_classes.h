// WidgetBlueprintGeneratedClass Footer_WBP.Footer_WBP_C
// Size: 0x4b0 (Inherited: 0x450)
struct UFooter_WBP_C : UGobiUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function Footer_WBP.Footer_WBP_C.PreConstruct // (None) // @ game+0xfffffffec0000000
};

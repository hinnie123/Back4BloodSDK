// BlueprintGeneratedClass GasCan_FirePool_BP.GasCan_FirePool_BP_C
// Size: 0x2b8 (Inherited: 0x278)
struct AGasCan_FirePool_BP_C : AMolotovFlame {
	...
	void Audio_Spawn_Fire_Loop(); // Function GasCan_FirePool_BP.GasCan_FirePool_BP_C.Audio_Spawn_Fire_Loop // (None) // @ game+0xfffffffec0000000
};

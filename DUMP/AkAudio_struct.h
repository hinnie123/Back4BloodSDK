...
// Enum AkAudio.ESplineMovementMode
...
// ScriptStruct AkAudio.AkPluginList
// Size: 0x10 (Inherited: 0x00)
struct FAkPluginList {
	struct TArray<struct FString> PluginNames; // 0x00(0x10)
};
...
// ScriptStruct AkAudio.AkTRSPerPlatformSettings
// Size: 0x04 (Inherited: 0x00)
struct FAkTRSPerPlatformSettings {
	float MaxSoundBankMemoryFootprintInMB; // 0x00(0x04)
};
...
// ScriptStruct AkAudio.AkPellegrinoAdvancedInitializationSettings
// Size: 0x40 (Inherited: 0x38)

// BlueprintGeneratedClass Molotov_FirePool_BP.Molotov_FirePool_BP_C
// Size: 0x2b8 (Inherited: 0x278)
struct AMolotov_FirePool_BP_C : AMolotovFlame {
	...
	void SpawnVFX(); // Function Molotov_FirePool_BP.Molotov_FirePool_BP_C.SpawnVFX // (None) // @ game+0xfffffffec0000000
};

...
struct FNavigationFilterArea {
	...
	float RandomCostOverride; // 0x10(0x04)
	char bIsExcluded : 1; // 0x14(0x01)
	char bOverrideTravelCost : 1; // 0x14(0x01)
	char bOverrideEnteringCost : 1; // 0x14(0x01)
	char bOverrideRandomCost : 1; // 0x14(0x01)

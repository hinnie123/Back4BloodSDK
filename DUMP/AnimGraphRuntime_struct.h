...
struct FAnimNode_BlendSpacePlayer : FAnimNode_AssetPlayerBase {
	...
	bool bInvertX; // 0x42(0x01)
	bool bInvertY; // 0x43(0x01)
	bool bInvertZ; // 0x44(0x01)
...
struct FAnimNode_RandomPlayer : FAnimNode_Base {
	bool bRandomStartPosition; // 0x10(0x01)
	char pad_11[0x7]; // 0x11(0x07)
	struct TArray<struct FRandomPlayerSequenceEntry> Entries; // 0x18(0x10)
	char pad_28[0x60]; // 0x28(0x60)
	bool bShuffleMode; // 0x88(0x01)
	char pad_89[0x7]; // 0x89(0x07)
};

...
struct UClothingSimulationInteractor : UObject {
	...
	void SetAnimDriveSpringStiffness(float InStiffness); // Function ClothingSystemRuntimeInterface.ClothingSimulationInteractor.SetAnimDriveSpringStiffness // (None) // @ game+0xfffffffec0000000
};

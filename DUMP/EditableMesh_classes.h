...
struct UEditableMesh : UObject {
	...
	void WeldVertices(struct TArray<struct FVertexID> VertexIDs, struct FVertexID OutNewVertexID); // Function EditableMesh.EditableMesh.WeldVertices // (None) // @ game+0xfffffffec0000000
};
...
struct UEditableMeshFactory : UObject {
	...
	struct UEditableMesh* MakeEditableMesh(struct UPrimitiveComponent* PrimitiveComponent, int32_t LODIndex); // Function EditableMesh.EditableMeshFactory.MakeEditableMesh // (None) // @ game+0xfffffffec0000000
};

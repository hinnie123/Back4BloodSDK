...
// Enum AIModule.EEnvQueryTestClampBehavior
enum class EEnvQueryTestClampBehavior : uint8 {
	Clamp = 0,
...
// Enum AIModule.EEnvItemStatus
enum class EEnvItemStatus : uint8 {
	Passed = 0,
	Failed = 1,
...
// ScriptStruct AIModule.AIDataProviderGameplayTagContainerValue
// Size: 0x50 (Inherited: 0x30)
struct FAIDataProviderGameplayTagContainerValue : FAIDataProviderStructValue {
	struct FGameplayTagContainer DefaultValue; // 0x30(0x20)
};
...
// ScriptStruct AIModule.AIDataProviderUObjectValue
// Size: 0x38 (Inherited: 0x30)
struct FAIDataProviderUObjectValue : FAIDataProviderTypedValue {
	struct UObject* DefaultValue; // 0x30(0x08)
};

// ScriptStruct AIModule.AIDataProviderGameplayTagQueryContainerValue
// Size: 0x78 (Inherited: 0x30)
struct FAIDataProviderGameplayTagQueryContainerValue : FAIDataProviderStructValue {
	struct FGameplayTagQuery DefaultValue; // 0x30(0x48)
};
...
// ScriptStruct AIModule.AISenseModInfo
// Size: 0x10 (Inherited: 0x00)
struct FAISenseModInfo {
	struct UAISense* SenseClass; // 0x00(0x08)
	float ModAdjustment; // 0x08(0x04)
...
struct FEQSParametrizedQueryExecutionRequest {
	...
	struct FAIDataProviderUObjectValue EQSDataProvider; // 0x18(0x38)
	struct FBlackboardKeySelector EQSQueryBlackboardKey; // 0x50(0x28)
	enum class EEnvQueryRunMode RunMode; // 0x78(0x01)
	char pad_79[0x3]; // 0x79(0x03)
	char bUseBBKeyForQueryTemplate : 1; // 0x7c(0x01)
...
// ScriptStruct AIModule.GenericTeam

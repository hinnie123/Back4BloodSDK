// BlueprintGeneratedClass GasGrenade_Cloud_BP.GasGrenade_Cloud_BP_C
// Size: 0x2b8 (Inherited: 0x278)
struct AGasGrenade_Cloud_BP_C : AMolotovFlame {
	...
	void Audio_Spawn_Fire_Loop(); // Function GasGrenade_Cloud_BP.GasGrenade_Cloud_BP_C.Audio_Spawn_Fire_Loop // (None) // @ game+0xfffffffec0000000
};

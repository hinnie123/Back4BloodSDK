...
// Enum Engine.EShadePipelineCacheMode
enum class EShadePipelineCacheMode : uint8 {
	Background = 0,
	Fast = 1,
	Precompile = 2,
	Paused = 3,
...
// Enum Engine.EInstanceSplineMeshAxis
enum class EInstanceSplineMeshAxis : uint8 {
	X = 0,
	Y = 1,
	Z = 2,
...
// Enum Engine.EStaticMeshDetailMode
enum class EStaticMeshDetailMode : uint8 {
	SMDM_Low = 0,
	SMDM_Medium = 1,
	SMDM_High = 2,
	SMDM_MAX = 3
...
// Enum Engine.ASTCOverrideSizeValue
enum class ASTCOverrideSizeValue : uint8 {
	ASTC_12x12 = 0,
	ASTC_10x10 = 1,
	ASTC_8x8 = 2,
	ASTC_6x6 = 3,
...
// Enum Engine.ELightingScenarioMapListBehavior
enum class ELightingScenarioMapListBehavior : uint8 {
...
struct FRepMovement {
	...
	bool bSmoothingTimeStamp; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	float SmoothingTimeStamp; // 0x34(0x04)
	char bSimulatedPhysicSleep : 1; // 0x38(0x01)
	char bRepPhysics : 1; // 0x38(0x01)
	char pad_38_2 : 6; // 0x38(0x01)
	enum class EVectorQuantization LocationQuantizationLevel; // 0x39(0x01)
	enum class EVectorQuantization VelocityQuantizationLevel; // 0x3a(0x01)
	enum class ERotatorQuantization RotationQuantizationLevel; // 0x3b(0x01)
};
...
// ScriptStruct Engine.RepRootMotionMontageLowFreq
// Size: 0x70 (Inherited: 0x00)
struct FRepRootMotionMontageLowFreq {
	bool bIsActive; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct UAnimMontage* AnimMontage; // 0x08(0x08)
	struct UPrimitiveComponent* MovementBase; // 0x10(0x08)
	struct FName MovementBaseBoneName; // 0x18(0x08)
	bool bRelativePosition; // 0x20(0x01)
	bool bRelativeRotation; // 0x21(0x01)
	char pad_22[0x6]; // 0x22(0x06)
	struct FRootMotionSourceGroup AuthoritativeRootMotion; // 0x28(0x38)
	struct FVector_NetQuantize10 Acceleration; // 0x60(0x0c)
	char pad_6C[0x4]; // 0x6c(0x04)
};

// ScriptStruct Engine.RepRootMotionMontageHighFreq
// Size: 0x28 (Inherited: 0x00)
struct FRepRootMotionMontageHighFreq {
	...
	struct FVector_NetQuantize10 LinearVelocity; // 0x1c(0x0c)
};
...
// ScriptStruct Engine.ShadowChannels
// Size: 0x01 (Inherited: 0x00)
struct FShadowChannels {
	...
	char bChannel4 : 1; // 0x00(0x01)
	char bChannel5 : 1; // 0x00(0x01)
...
struct FAnimNode_SequencePlayer : FAnimNode_AssetPlayerBase {
	...
	bool bRandomStartPosition; // 0x75(0x01)
...
struct FAnimNode_LinkedAnimGraph : FAnimNode_CustomProperty {
	...
	struct FGameplayTag InstanceTag; // 0x88(0x08)
	char pad_90[0x10]; // 0x90(0x10)
	char bReceiveNotifiesFromLinkedInstances : 1; // 0xa0(0x01)
	char bPropagateNotifiesToLinkedInstances : 1; // 0xa0(0x01)
...
// Size: 0x840 (Inherited: 0x6f0)
struct FAnimSingleNodeInstanceProxy : FAnimInstanceProxy {
	char pad_6F0[0x150]; // 0x6f0(0x150)
};
...
struct FPrimaryAssetRulesCustomOverride {
	...
	struct FPrimaryAssetRules Rules; // 0x28(0x20)
};
...
struct FPrimaryAssetRules {
	...
	char pad_A[0x6]; // 0x0a(0x06)
	struct FString ReleaseVersion; // 0x10(0x10)
};
...
struct FPrimaryAssetRulesOverride {
	...
	struct FPrimaryAssetRules Rules; // 0x10(0x20)
};
...
struct FPrimaryAssetTypeInfo {
	...
	struct FPrimaryAssetRules Rules; // 0x60(0x20)
...
struct FPostProcessSettings {
	...
	char bOverride_VolumetricFogGridPixelSizeScalar : 1; // 0x1e(0x01)
	char bOverride_FogDensity : 1; // 0x1e(0x01)
	char bOverride_FogHeightFalloff : 1; // 0x1e(0x01)
	char bOverride_FogStartDistance : 1; // 0x1e(0x01)
	...
	char bOverride_CasSharpening : 1; // 0x4a4(0x01)
	char pad_4A4_1 : 7; // 0x4a4(0x01)
	char pad_4A5[0x3]; // 0x4a5(0x03)
	float CasSharpening; // 0x4a8(0x04)
	char bOverride_EnableCasSharpening : 1; // 0x4ac(0x01)
	char EnableCasSharpening : 1; // 0x4ac(0x01)
	char pad_4AC_2 : 6; // 0x4ac(0x01)
	char pad_4AD[0x3]; // 0x4ad(0x03)
	float MotionBlurAmount; // 0x4b0(0x04)
	float MotionBlurMax; // 0x4b4(0x04)
	int32_t MotionBlurTargetFPS; // 0x4b8(0x04)
	float MotionBlurPerObjectSize; // 0x4bc(0x04)
	float LPVIntensity; // 0x4c0(0x04)
	float LPVVplInjectionBias; // 0x4c4(0x04)
	float LPVSize; // 0x4c8(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x4cc(0x04)
	float LPVSecondaryBounceIntensity; // 0x4d0(0x04)
	float LPVGeometryVolumeBias; // 0x4d4(0x04)
	float LPVEmissiveInjectionIntensity; // 0x4d8(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x4dc(0x04)
	float LPVDirectionalOcclusionRadius; // 0x4e0(0x04)
	float LPVDiffuseOcclusionExponent; // 0x4e4(0x04)
	float LPVSpecularOcclusionExponent; // 0x4e8(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x4ec(0x04)
	float LPVSpecularOcclusionIntensity; // 0x4f0(0x04)
	enum class EReflectionsType ReflectionsType; // 0x4f4(0x01)
	char pad_4F5[0x3]; // 0x4f5(0x03)
	float ScreenSpaceReflectionIntensity; // 0x4f8(0x04)
	float ScreenSpaceReflectionQuality; // 0x4fc(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x500(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x504(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x508(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x50c(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x510(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x511(0x01)
	char pad_511_1 : 7; // 0x511(0x01)
	enum class ETranslucencyType TranslucencyType; // 0x512(0x01)
	char pad_513[0x1]; // 0x513(0x01)
	float RayTracingTranslucencyMaxRoughness; // 0x514(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x518(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x51c(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x520(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x521(0x01)
	char pad_521_1 : 7; // 0x521(0x01)
	char pad_522[0x2]; // 0x522(0x02)
	int32_t PathTracingMaxBounces; // 0x524(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x528(0x04)
	float LPVFadeRange; // 0x52c(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x530(0x04)
	float ScreenPercentage; // 0x534(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x538(0x10)
	float VolumetricFogGridPixelSizeScalar; // 0x548(0x04)
	float FogDensity; // 0x54c(0x04)
	float FogHeightFalloff; // 0x550(0x04)
	float FogStartDistance; // 0x554(0x04)
...
// ScriptStruct Engine.AutoApplyProfileSettings
// Size: 0x10 (Inherited: 0x00)
struct FAutoApplyProfileSettings {
	double MinHeight; // 0x00(0x08)
	double MaxHeight; // 0x08(0x08)
};
...
struct FScreenMessageString {
	...
	char pad_2C[0x4]; // 0x2c(0x04)
	struct UWorld* RestrictToWorld; // 0x30(0x08)
};
...
struct FPredictProjectilePathParams {
	...
	float ProjectileHalfHeight; // 0x20(0x04)
	float MaxSimTime; // 0x24(0x04)
	bool bTraceWithChannel; // 0x28(0x01)
	enum class ECollisionChannel TraceChannel; // 0x29(0x01)
	char pad_2A[0x6]; // 0x2a(0x06)
	struct TArray<enum class EObjectTypeQuery> ObjectTypes; // 0x30(0x10)
	struct TArray<struct AActor*> ActorsToIgnore; // 0x40(0x10)
	float SimFrequency; // 0x50(0x04)
	float OverrideGravityZ; // 0x54(0x04)
	enum class EDrawDebugTrace DrawDebugType; // 0x58(0x01)
	char pad_59[0x3]; // 0x59(0x03)
	float DrawDebugTime; // 0x5c(0x04)
	bool bTraceComplex; // 0x60(0x01)
	char pad_61[0x3]; // 0x61(0x03)
	struct FName TraceProfile; // 0x64(0x08)
	char pad_6C[0x4]; // 0x6c(0x04)
};
...
struct FInstancedStaticMeshInstanceData {
	...
	struct FVector StartPos; // 0x40(0x0c)
	struct FVector EndPos; // 0x4c(0x0c)
	struct FVector StartTangent; // 0x58(0x0c)
	struct FVector EndTangent; // 0x64(0x0c)
	bool bSmoothInterpRollScale; // 0x70(0x01)
	char pad_71[0x3]; // 0x71(0x03)
	struct FVector2D StartScale; // 0x74(0x08)
	float StartRoll; // 0x7c(0x04)
	struct FVector2D StartOffset; // 0x80(0x08)
	struct FVector2D EndScale; // 0x88(0x08)
	float EndRoll; // 0x90(0x04)
	struct FVector2D EndOffset; // 0x94(0x08)
	struct FVector SplineUpDir; // 0x9c(0x0c)
	enum class EInstanceSplineMeshAxis ForwardAxis; // 0xa8(0x01)
	bool bIsSpline; // 0xa9(0x01)
...
// ScriptStruct Engine.PlaceProceduralActorsInput
// Size: 0x10 (Inherited: 0x00)
struct FPlaceProceduralActorsInput {
	struct TArray<struct FSpawnDetails> ActorsToSpawn; // 0x00(0x10)
};

// ScriptStruct Engine.SpawnDetails
// Size: 0x20 (Inherited: 0x00)
struct FSpawnDetails {
	struct TArray<struct FBlueprintSpawnDetails> BlueprintsToSpawn; // 0x00(0x10)
	struct TArray<struct FStaticMeshSpawnDetails> MeshesToSpawn; // 0x10(0x10)
};

// ScriptStruct Engine.StaticMeshSpawnDetails
// Size: 0xa0 (Inherited: 0x00)
struct FStaticMeshSpawnDetails {
	struct UStaticMesh* MeshToSpawn; // 0x00(0x08)
	struct TArray<struct UStaticMesh*> StaticMeshWhitelist; // 0x08(0x10)
	struct TMap<struct FName, struct UMaterialInterface*> MeshMaterials; // 0x18(0x50)
	char pad_68[0x8]; // 0x68(0x08)
	struct FTransform RelativeTransform; // 0x70(0x30)
};

// ScriptStruct Engine.BlueprintSpawnDetails
// Size: 0x50 (Inherited: 0x00)
struct FBlueprintSpawnDetails {
	struct UBlueprint* ActorToSpawn; // 0x00(0x08)
	struct TArray<struct UBlueprint*> BlueprintWhitelist; // 0x08(0x10)
...
struct FFontParameterValue {
	struct FMaterialParameterInfo ParameterInfo; // 0x00(0x18)
...
struct FVectorParameterValue {
	...
	struct FGuid ExpressionGUID; // 0x28(0x10)
};
...
struct FMeshProxySettings {
	...
	struct FName SourceAssetName; // 0xa8(0x08)
};
...
struct FMeshReductionSettings {
	...
	char pad_23[0x1]; // 0x23(0x01)
	struct FName SourceAssetName; // 0x24(0x08)
};
...
// ScriptStruct Engine.PrimitiveVectorParameter
// Size: 0x20 (Inherited: 0x00)
struct FPrimitiveVectorParameter {
	struct FName Name; // 0x00(0x08)
	struct FLinearColor Value; // 0x08(0x10)
	bool bUsesAlpha; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	int32_t Index; // 0x1c(0x04)
};

// ScriptStruct Engine.PrimitiveFloatParameter
// Size: 0x10 (Inherited: 0x00)
...
// ScriptStruct Engine.PrimitiveParameterCollectionOverrides
// Size: 0x30 (Inherited: 0x00)
struct FPrimitiveParameterCollectionOverrides {
	struct TArray<struct FFloatParameterTuple> FloatParameters; // 0x00(0x10)
	struct TArray<struct FVectorParameterTuple> VectorParameters; // 0x10(0x10)
	struct FGuid StateId; // 0x20(0x10)
};

// ScriptStruct Engine.VectorParameterTuple
// Size: 0x34 (Inherited: 0x00)
struct FVectorParameterTuple {
	...
	struct FLinearColor BaseValue; // 0x1c(0x10)
	bool bUsesAlpha; // 0x2c(0x01)
	char pad_2D[0x3]; // 0x2d(0x03)
	int32_t Index; // 0x30(0x04)
};

// ScriptStruct Engine.FloatParameterTuple
// Size: 0x18 (Inherited: 0x00)
...
struct FSplineMeshInstanceData : FStaticMeshComponentInstanceData {
	struct FVector StartPos; // 0x128(0x0c)
	struct FVector EndPos; // 0x134(0x0c)
	struct FVector StartTangent; // 0x140(0x0c)
	struct FVector EndTangent; // 0x14c(0x0c)
};
...
// ScriptStruct Engine.SpringArmIgnoreActorEntry
// Size: 0x58 (Inherited: 0x00)
struct FSpringArmIgnoreActorEntry {
	char pad_0[0x58]; // 0x00(0x58)
};

// ScriptStruct Engine.RawLodInfo
// Size: 0x28 (Inherited: 0x00)
struct FRawLodInfo {
	int32_t NumLODs; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
	struct TArray<struct FMeshBuildSettings> BuildSettings; // 0x08(0x10)
	struct TArray<struct FMeshReductionSettings> ReductionSettings; // 0x18(0x10)
};
...
struct FStaticMeshSourceModel {
	...
	struct FMeshReductionSettings ReductionSettings; // 0x30(0x2c)
	float LODDistance; // 0x5c(0x04)
	struct FPerPlatformFloat ScreenSize; // 0x60(0x04)
...
struct FLightmassWorldInfoSettings {
	struct TMap<enum class ELightingBuildQuality, struct FLightmassQualitySettings> LightmassSettingsPerQuality; // 0x00(0x50)
	struct FColor EnvironmentColor; // 0x50(0x04)
	float EnvironmentIntensity; // 0x54(0x04)
	float EmissiveBoost; // 0x58(0x04)
	float DiffuseBoost; // 0x5c(0x04)
	enum class EVolumeLightingMethod VolumeLightingMethod; // 0x60(0x01)
	char bUseAmbientOcclusion : 1; // 0x61(0x01)
	char bGenerateAmbientOcclusionMaterialMask : 1; // 0x61(0x01)
	char bVisualizeMaterialDiffuse : 1; // 0x61(0x01)
	char bVisualizeAmbientOcclusion : 1; // 0x61(0x01)
	char bCompressLightmaps : 1; // 0x61(0x01)
	char bCompressShadowmaps : 1; // 0x61(0x01)
	char pad_61_6 : 2; // 0x61(0x01)
	char pad_62[0x2]; // 0x62(0x02)
	float VolumetricLightmapDetailCellSize; // 0x64(0x04)
	float VolumetricLightmapMaximumBrickMemoryMb; // 0x68(0x04)
	float VolumetricLightmapSphericalHarmonicSmoothing; // 0x6c(0x04)
	float VolumeLightSamplePlacementScale; // 0x70(0x04)
	float DirectIlluminationOcclusionFraction; // 0x74(0x04)
	float IndirectIlluminationOcclusionFraction; // 0x78(0x04)
	float OcclusionExponent; // 0x7c(0x04)
	float FullyOccludedSamplesFraction; // 0x80(0x04)
	float MaxOcclusionDistance; // 0x84(0x04)
	struct UDataTable* LightingScenarioMapConfig; // 0x88(0x08)
};

// ScriptStruct Engine.LightmassQualitySettings
// Size: 0x14 (Inherited: 0x00)
...
// ScriptStruct Engine.LightingScenarioMapData
// Size: 0x20 (Inherited: 0x08)
struct FLightingScenarioMapData : FTableRowBase {
	enum class ELightingScenarioMapListBehavior ListBehavior; // 0x08(0x01)
	char pad_9[0x7]; // 0x09(0x07)
	struct TArray<struct FSoftObjectPath> MapList; // 0x10(0x10)
};
